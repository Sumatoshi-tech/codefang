//! GENERATED by uastmap2rs — transpiled from `tsx.uastmap`. Do not edit by
//! hand; re-run the transpiler and commit its output instead.

use cf_uast_mapping::{uast_language, LanguageMapping};

/// Mapping table for the `tsx` language.
pub static TSX: LanguageMapping = uast_language! {
    name: "tsx",
    extensions: [".tsx"],
    rules: {
        program => {
        ...
        // function detection.
        public_field_definition_arrow ("(public_field_definition)") => {
            type: Method,
            roles: [Function, Declaration, Member],
        ...
        public_field_definition_funcexpr ("(public_field_definition)") => {
            type: Method,
            roles: [Function, Declaration, Member],
            children: ["computed_property_name", "decorator", "expression", "number", "private_property_identifier", "property_identifier", "string", "type_annotation"],
        ...
        jsx_element => {
            ...
            token: self,
            roles: [Call],
            children: ["jsx_opening_element", "jsx_closing_element", "jsx_text", "jsx_expression", "jsx_element", "jsx_self_closing_element"],
        },
        jsx_self_closing_element => {
            type: Call,
            token: self,
            roles: [Call],
            children: ["identifier", "member_expression", "jsx_namespace_name", "type_arguments", "jsx_attribute", "jsx_expression"],
        },
        jsx_opening_element => {
            type: Synthetic,
            token: self,
        ...
        jsx_closing_element => {
            type: Synthetic,
            token: self,
            children: ["identifier", "member_expression", "jsx_namespace_name"],
        },
        jsx_fragment => {
            type: Call,
            token: self,
        ...
        jsx_attribute => {
            ...
            token: self,
            roles: [Member],
            children: ["property_identifier", "jsx_namespace_name", "string", "jsx_expression"],
        },
        jsx_namespace_name => {
            type: Identifier,
            token: self,
