//! GENERATED by uastmap2rs — transpiled from `markdown.uastmap`. Do not edit by
...
/// Mapping table for the `markdown` language.
#[rustfmt::skip]
pub static MARKDOWN: LanguageMapping = LanguageMapping {
    name: "markdown",
