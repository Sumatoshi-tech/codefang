...
func TestNewDataExtractor_WithCustomExtractors(t *testing.T) {
	customNameExtractor := func(n *node.Node) (string, bool) {
		return "custom_name", true
	}
	customValueExtractor := func(n *node.Node) (interface{}, bool) {
...
func TestDataExtractor_ExtractValue(t *testing.T) {
	customExtractor := func(n *node.Node) (interface{}, bool) {
		if n != nil {
			return 42, true
		}
		return nil, false
...
func TestDataExtractor_ExtractNodePosition(t *testing.T) {
	...
	if pos["start_line"].(uint) != 10 {
		t.Errorf("expected start_line 10, got %v", pos["start_line"])
	}
	if pos["end_line"].(uint) != 20 {
		t.Errorf("expected end_line 20, got %v", pos["end_line"])
	}
...
func TestMergeNameExtractors(t *testing.T) {
	defaults := map[string]NameExtractor{
		"default1": func(n *node.Node) (string, bool) { return "default", true },
	}
	custom := map[string]NameExtractor{
		"custom1": func(n *node.Node) (string, bool) { return "custom", true },
	}
...
func TestMergeValueExtractors(t *testing.T) {
	defaults := map[string]ValueExtractor{
		"default1": func(n *node.Node) (interface{}, bool) { return "default", true },
	}
	custom := map[string]ValueExtractor{
		"custom1": func(n *node.Node) (interface{}, bool) { return "custom", true },
	}
