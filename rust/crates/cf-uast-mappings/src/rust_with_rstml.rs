//! GENERATED by uastmap2rs — transpiled from `rust_with_rstml.uastmap`. Do not edit by
...
/// Mapping table for the `rust_with_rstml` language.
#[rustfmt::skip]
pub static RUST_WITH_RSTML: LanguageMapping = LanguageMapping {
    ...
    rules: &[
        ...
        MappingRule {
            ...
            uast_type: UastType::Literal,
            token: TokenSource::SelfText,
            roles: &[Role::Literal, Role::Literal],
            children: &[],
            props: &[],
            conditions: &[],
        },
        ...
        MappingRule {
            ...
            token: TokenSource::SelfText,
            roles: &[Role::Body, Role::Attribute],
        ...
        MappingRule {
            ...
            token: TokenSource::SelfText,
            roles: &[Role::Parameter, Role::Continue],
            children: &[],
            props: &[],
            conditions: &[],
        },
        ...
        MappingRule {
            ...
            uast_type: UastType::Function,
            token: TokenSource::SelfText,
            roles: &[Role::Function, Role::Declaration, Role::Function, Role::Declaration],
        ...
        MappingRule {
            ...
            uast_type: UastType::Pattern,
            token: TokenSource::SelfText,
            roles: &[Role::Parameter, Role::Pattern],
            children: &[],
            props: &[],
            conditions: &[],
        },
        ...
        MappingRule {
            ...
            uast_type: UastType::Pattern,
            token: TokenSource::SelfText,
            roles: &[Role::Literal, Role::Pattern],
            children: &[],
            props: &[],
            conditions: &[],
        },
        ...
        MappingRule {
            ...
            uast_type: UastType::Field,
            token: TokenSource::SelfText,
            roles: &[Role::Parameter, Role::Member],
            children: &[],
            props: &[],
            conditions: &[],
        },
