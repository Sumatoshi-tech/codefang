...
# ============================================================================
# This is the GENERALIZATION of rust/tests/antisim/parity_gate.sh onto the
...
ORACLE="$ROOT/rust/tests/compat/oracle/oracle.py"
...
ru_raw(){ local b="$1"; shift; case "$b" in uast) "$ROOT/rust/target/release/uast" "$@";; *) "$ROOT/rust/target/release/codefang" "$b" "$@";; esac 2>/dev/null; }
